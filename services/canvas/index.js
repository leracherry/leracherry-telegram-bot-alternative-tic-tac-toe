        ...
        for (let innerRow = 0; innerRow < 3; innerRow++) {
          for (let innerCol = 0; innerCol < 3; innerCol++) {
            ...
            for (let item = 0; item < arrayFigures.length; item++) {
              // Рисование нолика
              if (
                row === arrayFigures[item].row &&
                col === arrayFigures[item].col &&
                innerRow === arrayFigures[item].innerRow &&
                innerCol === arrayFigures[item].innerCol
              ) {
                ...
                if (arrayFigures[item].figure === 'X') {
                  ...
                  canvasContext.lineTo(
                    innerX + innerSquareSize - 10,
                    innerY + innerSquareSize - 10,
                  );
